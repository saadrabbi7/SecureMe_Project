...
<div class="container-fluid">  
    <div class="card">
        ...
        <div class="card-body">
            <form style="margin-left: 10px" class="form-horizontal" action="{{ route('blood-banks.update', $data->id) }}" method="post">
                @method('PUT')
                @csrf 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="person_name" name="person_name" value="{{ $data->person_name ?? null }}" class="form-control" placeholder="Enter Name" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="phone_number" class="col-sm-2 pt-2">Number</label>
                    <div class="col-sm-10">
                        <input type="number" id="phone_number" name="phone_number" value="{{ $data->phone_number ?? null }}" class="form-control" placeholder="Enter Number">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="blood_group" id="blood_group" class="form-control">
                            ...
                            @foreach ($bloodGroups as $bloodGroup)
                                <option value="{{ $bloodGroup }}" {{ ($data->blood_group == $bloodGroup) ? "selected" : "" }}>
                                    {{ $bloodGroup }}
                                </option>
                            @endforeach
                        </select>
